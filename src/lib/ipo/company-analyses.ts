...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "14,52,74,728 shares / 2.3147×", context: "Official 12:40:16 p.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 2,19,04,666 QIB, 7,90,32,814 NII, 4,39,94,406 retail and 3,42,842 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "60,63,66,656 shares / 9.6615×", context: "Official current-issue endpoint at approximately 12:40 p.m. IST on 19 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "3,34,99,000 shares / 0.1333×", context: "Official 12:40:16 p.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,86,750 QIB, 18,70,250 NII, 72,44,250 retail and 1,97,750 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "5,44,73,250 shares / 0.2167×", context: "Official current-issue endpoint at approximately 12:40 p.m. IST on 19 August. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "54,39,360 bids / 0.1968×", context: "Official category book at 12:11:32 p.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: 8,64,000 QIB, 19,66,560 NII and 26,08,800 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "1,14,43,520 bids / 0.4141×", context: "Official current-issue endpoint at approximately 12:11 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "1,58,48,017 bids / 2.8888×", context: "Official category book at 12:11:32 p.m. IST on 19 August against the 54,86,051-share post-anchor pool: 82,820 QIB, 67,05,058 NII and 90,60,139 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "4,07,00,659 bids / 7.4189×", context: "Official current-issue endpoint at approximately 12:11 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day live book", value: "36,13,608 bids / 0.1427×", context: "Official 12:11:32 p.m. IST snapshot against 2,53,28,946 displayed shares: 2,604 QIB, 10,00,866 NII and 26,10,138 retail shares bid. The denominator uses the floor-price maximum; this remains an intraday, preliminary book." },
    { label: "NSE opening-day live display", value: "51,93,771 bids / 0.2051×", context: "Official current-issue endpoint at approximately 12:11 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day live snapshot", value: "50,15,200 bids / 1.17×", context: "Official feed at approximately 12:40 p.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.23× the residual 40,78,400-share public pool by calculation. This is an intraday aggregate, not a final category-wise figure." },
