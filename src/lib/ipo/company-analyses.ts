...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. BSE's category snapshot at 16:27:21 IST on 17 August records 1,86,67,536 shares bid for, or 0.2974× the displayed pool. This is an intraday observation rather than a final demand reading.",
  ...
  metrics: [
    ...
    { label: "BSE intraday demand", value: "1,86,67,536 shares / 0.2974×", context: "Official 16:27:21 IST snapshot on 17 August against the 6,27,61,403-share post-anchor exchange pool: 1,18,95,500 QIB, 18,28,022 NII, 47,94,312 retail and 1,49,702 employee shares bid. The book remains preliminary and can change through the issue period." },
  ...
  metrics: [
    ...
    { label: "BSE intraday demand", value: "2,69,76,000 shares / 0.1073×", context: "Official 16:27:21 IST snapshot on 17 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,33,000 QIB, 4,59,750 NII, 22,97,750 retail and 85,500 employee shares bid. The book remains preliminary and can change through the issue period." },
  ],
  strengths: [
