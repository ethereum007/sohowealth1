...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. BSE's official book timestamped 12:36:25 a.m. IST on 19 August showed 5,36,03,232 bids, or 0.8541×: QIB 1.0108×, NII 1.1451×, retail 0.6415× and employee 0.7055×. NSE's current-issue endpoint at the same midnight checkpoint displayed 14,04,15,518 bids, or 2.2373× against the same offered-share count. The exchange views are retained separately rather than added because their aggregation basis is not confirmed; bidding continues through 19 August and both readings remain preliminary. BSE issue record 7886 showed no addendum or corrigendum at the same recheck.",
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "5,36,03,232 shares / 0.8541×", context: "Official 12:36:25 a.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 1,80,24,254 QIB, 1,53,14,152 NII, 2,00,17,296 retail and 2,47,530 employee shares bid. The book remains preliminary and can change through the final issue day." },
    { label: "NSE final-day opening display", value: "14,04,15,518 shares / 2.2373×", context: "NSE's current-issue endpoint rechecked separately at the midnight 19 August checkpoint. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "3,05,43,500 shares / 0.1215×", context: "Official 12:36:25 a.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,83,250 QIB, 11,01,000 NII, 51,22,000 retail and 1,37,250 employee shares bid. The book remains preliminary and can change through the final issue day." },
    { label: "NSE final-day opening display", value: "2,91,02,500 shares / 0.1158×", context: "NSE's current-issue endpoint rechecked separately at the midnight 19 August checkpoint. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day opening snapshot", value: "40,81,600 bids / 0.95×", context: "Official feed rechecked at approximately 12:36 a.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.00× the residual 40,78,400-share public pool by calculation. The issue remains active through 19 August and this is not a final category-wise figure." },
