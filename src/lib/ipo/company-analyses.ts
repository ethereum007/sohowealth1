...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE opening-day midday demand", value: "9,98,080 bids / 0.0361×", context: "Official 12:35:16 p.m. IST 18 August category-book snapshot against the 2,76,37,400-share post-anchor public pool: QIB 0.0000×, NII 0.0122× and retail 0.0670×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day midday demand display", value: "33,69,760 bids / 0.1219×", context: "NSE's current-issue endpoint frozen separately at approximately 12:36 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE live demand snapshot", value: "0.91×", context: "38,89,600 bids versus the 42,93,600-share gross offer at the approximately 12:08 p.m. IST 18 August recheck; the issue remains active through 19 August and this is not a final category-wise figure." },
  ...
  issueNote: "The 9 August RHP confirms an entirely fresh issue of up to 29,45,600 shares, including a 1,48,800-share market-maker reservation and a 27,96,800-share net issue, with bidding from 14–18 August. The lead manager's official price advertisement sets a ₹73–₹77 band and a minimum bid of 3,200 shares, with subsequent bids in multiples of 1,600. That minimum application is ₹2,33,600–₹2,46,400. NSE's current-issue feed frozen at approximately 1:06 p.m. IST on 18 August kept the issue active on its final scheduled day and recorded 42,99,200 bids against 29,45,600 displayed gross-offer shares, or 1.46×. The displayed denominator includes the 1,48,800-share market-maker reservation; against the residual 27,96,800-share public pool, the same demand is approximately 1.54× by calculation. Both are provisional total-demand readings and should not be confused with final or category-wise subscription. Final price, allotment and listing remain subject to NSE Emerge notices.",
  ...
  metrics: [
    ...
    { label: "NSE final-day early-afternoon demand", value: "42,99,200 bids / 1.46×", context: "Official feed frozen at approximately 1:06 p.m. IST on 18 August against the 29,45,600-share displayed gross offer. Because that denominator includes 1,48,800 market-maker shares, demand is approximately 1.54× the residual 27,96,800-share public pool by calculation. The reading remains interim and is not category-wise." },
  ...
  metrics: [
    ...
    { label: "BSE final-day early-afternoon demand", value: "1,03,66,800 bids / 4.0238×", context: "Official 1:05:48 p.m. IST 18 August snapshot against 25,76,400 displayed post-anchor shares: QIB 4.5018×, NII 4.2401× and retail 3.6253×. The pool still includes 1,81,200 market-maker shares; demand equals approximately 4.33× the residual public pool by calculation and remains interim." },
