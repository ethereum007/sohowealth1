...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. At 12:04:37 p.m. IST on 18 August, BSE's category book showed 2,84,15,260 bids, or 0.4528×: QIB 0.6692×, NII 0.4285×, retail 0.3384× and employee 0.5490×. NSE's current-issue endpoint, rechecked separately at approximately 12:08 p.m., displayed 5,85,94,310 bids, or 0.9336× against the same offered-share count. The exchange views are retained separately rather than added because their aggregation basis is not confirmed; bidding continues through 19 August and both readings remain preliminary.",
  ...
  metrics: [
    ...
    { label: "BSE day-two midday demand", value: "2,84,15,260 shares / 0.4528×", context: "Official 12:04:37 p.m. IST snapshot on 18 August against the 6,27,61,403-share post-anchor exchange pool: 1,19,32,944 QIB, 57,30,190 NII, 1,05,59,504 retail and 1,92,622 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE day-two midday demand display", value: "5,85,94,310 shares / 0.9336×", context: "NSE's current-issue endpoint rechecked separately at approximately 12:08 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE day-two midday demand", value: "2,88,18,750 shares / 0.1147×", context: "Official 12:35:16 p.m. IST snapshot on 18 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,33,000 QIB, 6,86,500 NII, 38,96,250 retail and 1,03,000 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE day-two midday demand display", value: "1,48,78,500 shares / 0.0592×", context: "NSE's current-issue endpoint frozen separately at approximately 12:36 p.m. IST on 18 August. Its materially lower reading is preserved as a separate exchange view because the aggregation basis is not confirmed; the feeds are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day midday demand", value: "25,87,633 bids / 0.4717×", context: "Official 12:35:16 p.m. IST 18 August category-book snapshot against the 54,86,051-share post-anchor public pool: QIB 0.0058×, NII 0.7112× and retail 0.6353×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day midday demand display", value: "67,14,898 bids / 1.2240×", context: "NSE's current-issue endpoint frozen separately at approximately 12:36 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
