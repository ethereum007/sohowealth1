...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  concerns: [
    ...
    "The company had not placed orders for certain offer-funded medical equipment and could not obtain multiple quotations for some specialised machines. Quotation expiry, imported-equipment lead times and cost escalation could change the ₹45.15 crore budget.",
