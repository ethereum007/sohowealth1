...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  concerns: [
    ...
    "Only ₹5 lakh, or 0.4%, of the ₹12.50 crore additional-facility estimate had been deployed at the RHP date, entirely against land under an MoU. Civil work and machinery deployment were nil, while commercial operations are targeted for July 2027 and the issuer expects the facility to double aggregate capacity.",
  ...
  monitor: [
    ...
    "Conversion of the land MoU into enforceable title or lease rights, civil and machinery orders, spend against the ₹12.50 crore budget, July 2027 commissioning, installed capacity, utilisation and employee count.",
