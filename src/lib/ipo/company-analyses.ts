...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE day-one close snapshot", value: "34,04,960 bids / 0.1232×", context: "Official 5:00 p.m. IST 18 August category book against the 2,76,37,400-share post-anchor public pool: QIB 0.0041×, NII 0.2823× and retail 0.1231×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE day-one later demand display", value: "64,71,840 bids / 0.2342×", context: "NSE showed the same value at the 18 August evening check and at approximately 3:40 a.m. IST on 19 August. The overnight display is carry-forward data before the second bidding session; it is kept separate from BSE's category book because the exchange aggregation basis is not confirmed." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE day-one close snapshot", value: "63,10,392 bids / 1.1503×", context: "Official 5:00 p.m. IST 18 August category book against the 54,86,051-share post-anchor public pool: QIB 0.0206×, NII 1.9540× and retail 1.4513×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE day-one later demand display", value: "1,74,64,319 bids / 3.1834×", context: "NSE showed the same value at the 18 August evening check and at approximately 3:40 a.m. IST on 19 August. The overnight display is carry-forward data before the second bidding session; it is kept separate from BSE's category book because the exchange aggregation basis is not confirmed." },
  ],
  strengths: [
