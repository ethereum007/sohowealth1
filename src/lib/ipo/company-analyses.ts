...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  slug: "qt-foods-ipo", company: "Q&T Foods", market: "SME", sector: "Fresh bakery products", status: "Listing confirmed for 19 August 2026 at ₹115 on BSE SME", analysisAsOf: "19 August 2026",
  ...
  slug: "pramodini-medicare-ipo", company: "Pramodini Medicare", market: "SME", sector: "Diagnostic imaging, laboratory and nuclear-medicine services", status: "Issue closed; NSE still shows final price and listing as unavailable", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE exchange status", value: "Past issues; fields blank", context: "The official early-19-August recheck still showed dashes for final issue price and listing date; the proposed 19 August listing is not treated as confirmed." },
  ],
  strengths: [
