...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "FY27 IPO-funded working capital", value: "₹25.15cr of ₹68.95cr", context: "The RHP expects ₹43.80 crore of the projected gap to remain funded through internal sources and bank borrowing." },
