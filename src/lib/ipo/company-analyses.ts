...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "20,67,98,180 shares / 3.2950×", context: "Official 1:41:16 p.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 5,56,49,184 QIB, 9,86,67,382 NII, 5,21,12,354 retail and 3,69,260 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "90,75,50,800 shares / 14.4603×", context: "Official current-issue endpoint at approximately 1:40 p.m. IST on 19 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "8,24,88,000 shares / 0.3282×", context: "Official 1:41:03 p.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 7,02,61,000 QIB, 41,31,500 NII, 78,82,000 retail and 2,13,500 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "5,90,63,500 shares / 0.2350×", context: "Official current-issue endpoint at approximately 1:40 p.m. IST on 19 August. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "65,34,240 bids / 0.2364×", context: "Official category book at 2:16:14 p.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: 14,43,360 QIB, 20,85,760 NII and 30,05,120 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "1,36,12,160 bids / 0.4925×", context: "Official current-issue endpoint at approximately 2:15 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "2,07,61,170 bids / 3.7844×", context: "Official category book at 2:13:43 p.m. IST on 19 August against the 54,86,051-share post-anchor pool: 98,154 QIB, 89,13,318 NII and 1,17,49,698 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "5,62,59,626 bids / 10.2550×", context: "Official current-issue endpoint at approximately 2:15 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day live book", value: "63,72,360 bids / 0.2516×", context: "Official 2:13:43 p.m. IST snapshot against 2,53,28,946 displayed shares: 6,27,657 QIB, 16,64,793 NII and 40,79,910 retail shares bid. The denominator uses the floor-price maximum; this remains an intraday, preliminary book." },
    { label: "NSE opening-day live display", value: "83,71,488 bids / 0.3305×", context: "Official current-issue endpoint at approximately 2:15 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day live snapshot", value: "55,13,600 bids / 1.28×", context: "Official feed at approximately 1:40 p.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.35× the residual 40,78,400-share public pool by calculation. This is an intraday aggregate, not a final category-wise figure." },
