...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE post-window snapshot", value: "1,01,25,66,050 shares / 16.1336×", context: "Official 5:09:18 p.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 79,00,02,022 QIB, 14,63,03,180 NII, 7,58,08,412 retail and 4,52,436 employee shares bid. It was retrieved after the 5 p.m. bid window, but final reconciled subscription remains pending." },
    { label: "NSE post-window display", value: "2,93,95,16,726 shares / 46.8364×", context: "Official current-issue endpoint at approximately 5:10 p.m. IST on 19 August still labelled the issue Active. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together or described as final." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7886 at 5:11:51 p.m. IST still showed 17–19 August bidding, ₹190–₹201, a 74-share minimum and blank addendum, corrigendum and remarks fields." },
  ...
  metrics: [
    ...
    { label: "BSE post-window snapshot", value: "13,66,82,000 shares / 0.5438×", context: "Official 5:09:18 p.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 11,13,62,500 QIB, 1,45,26,000 NII, 1,05,43,750 retail and 2,49,750 employee shares bid. It was retrieved after the 5 p.m. bid window, but final reconciled subscription remains pending." },
    { label: "NSE post-window display", value: "22,71,11,000 shares / 0.9035×", context: "Official current-issue endpoint at approximately 5:10 p.m. IST on 19 August still labelled the issue Active. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together or described as final." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7890 at 5:10:03 p.m. IST still showed 17–19 August bidding, ₹57–₹60, a 250-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE post-window live snapshot", value: "62,39,200 bids / 1.45×", context: "Official feed at approximately 5:10 p.m. IST on 19 August against the 42,93,600-share displayed gross offer still labelled the issue Active. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.53× the residual 40,78,400-share public pool by calculation. This is not a final category-wise figure." },
    { label: "Extension evidence", value: "Window ended 19 Aug", context: "The NSE feed superseded the RHP's original 13 August close and displayed an extended 19 August end date. Final category demand, allotment and the revised listing timetable still require controlling exchange notices." },
