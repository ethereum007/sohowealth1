...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  slug: "milky-mist-dairy-food-ipo", company: "Milky Mist Dairy Food", market: "Mainboard", sector: "Value-added dairy products", status: "Listed 18 August 2026; special pre-open discovered ₹165", analysisAsOf: "18 August 2026",
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. BSE's category book records 1,88,84,800 shares bid at its 17:00 IST day-one close, or 0.3009× the displayed pool. NSE's current-issue endpoint, rechecked at 8:59 p.m. IST, separately displayed 2,46,69,232 bids, or 0.3931× against the same offered-share count. The later NSE total is retained as a separate exchange display rather than added to BSE's category book; bidding continues through 19 August and both readings remain preliminary.",
  ...
  metrics: [
    ...
    { label: "BSE day-one demand", value: "1,88,84,800 shares / 0.3009×", context: "Official 17:00 IST close snapshot on 17 August against the 6,27,61,403-share post-anchor exchange pool: 1,18,95,500 QIB, 18,77,972 NII, 49,59,110 retail and 1,52,218 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE evening demand display", value: "2,46,69,232 shares / 0.3931×", context: "NSE's current-issue endpoint rechecked at 8:59 p.m. IST on 17 August. It is shown separately from BSE's 17:00 category book because the two feeds have different timestamps and should not be added together without a confirmed aggregation basis." },
  ...
  metrics: [
    ...
    { label: "BSE day-one demand", value: "2,70,56,750 shares / 0.1076×", context: "Official 17:00 IST close snapshot on 17 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,33,000 QIB, 4,71,000 NII, 23,66,000 retail and 86,750 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE evening demand display", value: "82,37,250 shares / 0.0328×", context: "NSE's current-issue endpoint rechecked at 8:59 p.m. IST on 17 August. The lower figure conflicts with any interpretation of BSE's earlier total as the same consolidated book, so it is preserved as a separate exchange view pending final reconciliation." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "Opening exchange state", value: "Active; pre-market book unavailable", context: "NSE classified the issue active on 18 August, but its offered-share and bid fields were still zero at the 8:06 a.m. IST recheck. The verified post-anchor public pool is 2,76,37,400 shares, so zero is treated as a feed placeholder rather than subscription demand." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "Opening exchange state", value: "Active; pre-market book unavailable", context: "NSE classified the issue active on 18 August, but its offered-share and bid fields were still zero at the 8:06 a.m. IST recheck. The verified post-anchor public pool is 54,86,051 shares, so zero is treated as a feed placeholder rather than subscription demand." },
  ],
  strengths: [
  ...
  issueNote: "The 9 August RHP confirms an entirely fresh issue of up to 29,45,600 shares, including a 1,48,800-share market-maker reservation and a 27,96,800-share net issue, with bidding from 14–18 August. The lead manager's official price advertisement sets a ₹73–₹77 band and a minimum bid of 3,200 shares, with subsequent bids in multiples of 1,600. That minimum application is ₹2,33,600–₹2,46,400. NSE's 8:06 a.m. IST 18 August feed kept the issue active on its final scheduled day and carried forward 27,50,400 bids against 29,45,600 displayed offer shares, or 0.93×, before the market opened. That exchange display uses the gross offer including the market-maker reservation, so it is a provisional total-demand reading and should not be confused with final or category-wise subscription. Final price, allotment and listing remain subject to NSE Emerge notices.",
  ...
  metrics: [
    ...
    { label: "NSE live demand snapshot", value: "0.93×", context: "27,50,400 bids versus the 29,45,600-share exchange-displayed gross offer at the 8:06 a.m. IST 18 August recheck. The issue was active on its final scheduled day, but the carried-forward pre-market figure is not final or category-wise demand." },
  ...
  metrics: [
    ...
    { label: "BSE final-day morning demand", value: "36,84,000 bids / 1.4299×", context: "Official 9:34:44 a.m. IST 18 August snapshot against 25,76,400 displayed post-anchor shares: QIB 1.0000×, NII 2.0898× and retail 1.2926×. The pool still includes 1,81,200 market-maker shares; demand equals approximately 1.54× the residual public pool by calculation and remains interim." },
  ...
  metrics: [
    ...
    { label: "BSE final-day morning demand", value: "1,89,38,000 bids / 5.7284×", context: "Official 9:34:44 a.m. IST 18 August snapshot against 33,06,000 displayed post-anchor shares: QIB 0.8917×, NII 4.5567× and retail 9.1651×. The pool still includes 2,31,000 market-maker shares; demand equals approximately 6.16× the residual public pool by calculation and remains interim." },
