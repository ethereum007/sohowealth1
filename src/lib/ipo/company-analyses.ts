...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. The final RHP locks 50% of anchor shares for 90 days from allotment and the remaining 50% for 30 days. Because the aggregate anchor allocation is an odd number, the exact integer split and depository unlock dates require the final allotment record; if allotment follows the RHP's indicative 20 August timetable, 19 September and 18 November are only calendar illustrations. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. BSE's official book timestamped 4:17:35 a.m. IST on 19 August showed 5,36,16,996 bids, or 0.8543×: QIB 1.0108×, NII 1.1454×, retail 0.6418× and employee 0.7055×. NSE's current-issue endpoint at the same pre-session checkpoint still displayed 14,04,15,518 bids, or 2.2373× against the same offered-share count. These overnight values are carry-forward snapshots before the final bidding session, not new 19 August demand. The exchange views are retained separately rather than added because their aggregation basis is not confirmed; bidding continues through 19 August and both readings remain preliminary. BSE issue record 7886 showed no addendum or corrigendum at the same recheck.",
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "5,36,32,906 shares / 0.8546×", context: "Official 6:41:57 a.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 1,80,24,254 QIB, 1,53,23,846 NII, 2,00,37,276 retail and 2,47,530 employee shares bid. This is a pre-session carry-forward book and remains preliminary." },
    { label: "NSE final-day opening display", value: "14,04,15,518 shares / 2.2373×", context: "NSE's current-issue endpoint was unchanged at the approximately 6:42 a.m. IST 19 August checkpoint. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "3,05,45,750 shares / 0.1215×", context: "Official 6:38:52 a.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,83,250 QIB, 11,01,000 NII, 51,23,750 retail and 1,37,750 employee shares bid. This is a pre-session carry-forward book and remains preliminary." },
    { label: "NSE final-day opening display", value: "2,91,02,500 shares / 0.1158×", context: "NSE's current-issue endpoint was unchanged at the approximately 6:42 a.m. IST 19 August checkpoint. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE pre-session demand snapshot", value: "35,14,560 bids / 0.1272×", context: "Official category book timestamped 6:41:57 a.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: QIB 0.0041×, NII 0.2843× and retail 0.1301×. It is a later processing snapshot than the prior close view, not new second-session demand." },
    { label: "NSE pre-session demand display", value: "64,71,840 bids / 0.2342×", context: "NSE carried the same value from the 18 August evening check into the approximately 6:42 a.m. IST 19 August pre-session check. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE pre-session demand snapshot", value: "66,38,187 bids / 1.2100×", context: "Official category book timestamped 6:41:57 a.m. IST on 19 August against the 54,86,051-share post-anchor pool: QIB 0.0206×, NII 1.9920× and retail 1.5545×. It is a later processing snapshot than the prior close view, not new second-session demand." },
    { label: "NSE pre-session demand display", value: "1,74,64,319 bids / 3.1834×", context: "NSE carried the same value from the 18 August evening check into the approximately 6:42 a.m. IST 19 August pre-session check. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "Opening-day pre-market state", value: "Zero bids before market open", context: "At approximately 6:11 a.m. IST on 19 August, NSE marked Gaja Active but displayed zero offered shares and bids; BSE's still-untimestamped table showed zero bids against 2,53,28,946 shares. Neither is a demand reading. BSE's denominator uses the floor-price maximum, while the cap-price offer less the confirmed anchor allocation implies 2,40,62,500 shares." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day opening snapshot", value: "40,81,600 bids / 0.95×", context: "Official feed was unchanged at approximately 6:11 a.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.00× the residual 40,78,400-share public pool by calculation. This is a pre-session carry-forward value, not a final category-wise figure." },
  ...
  slug: "skytech-infinite-platform-ipo", company: "Skytech Infinite Platform", market: "SME", sector: "Industrial automation, control panels and turnkey engineering", status: "Issue closed; absent from NSE current and past issue tables at early 19 August recheck", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE exchange transition", value: "Absent from both tables", context: "At the early-19-August IST recheck, Skytech was no longer in NSE's current feed but had not appeared in the public past-issues table; final price and listing remain unavailable." },
