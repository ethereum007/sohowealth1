...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "NSE day-one later demand display", value: "64,71,840 bids / 0.2342×", context: "NSE's current-issue endpoint rechecked separately at approximately 6:05 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE day-one later demand display", value: "1,74,64,319 bids / 3.1834×", context: "NSE's current-issue endpoint rechecked separately at approximately 6:05 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  slug: "gaja-alternative-asset-management-ipo", company: "Gaja Alternative Asset Management", market: "Mainboard", sector: "Private equity and alternative asset management", status: "Issue active on NSE; bidding scheduled 19–21 August 2026", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "Opening-day pre-market state", value: "Zero bids before market open", context: "At approximately 12:36 a.m. IST on 19 August, NSE marked Gaja Active but displayed zero offered shares and bids; BSE's untimestamped table showed zero bids against 2,53,28,946 shares. Neither is a demand reading. BSE's denominator uses the floor-price maximum, while the cap-price offer less the confirmed anchor allocation implies 2,40,62,500 shares." },
  ],
  strengths: [
