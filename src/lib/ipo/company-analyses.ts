...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "5,36,24,914 shares / 0.8544×", context: "Official 6:11:16 a.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 1,80,24,254 QIB, 1,53,21,774 NII, 2,00,31,356 retail and 2,47,530 employee shares bid. This is a pre-session carry-forward book and remains preliminary." },
    { label: "NSE final-day opening display", value: "14,04,15,518 shares / 2.2373×", context: "NSE's current-issue endpoint was unchanged at the approximately 6:11 a.m. IST 19 August checkpoint. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "3,05,45,500 shares / 0.1215×", context: "Official 6:11:16 a.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,83,250 QIB, 11,01,000 NII, 51,23,500 retail and 1,37,750 employee shares bid. This is a pre-session carry-forward book and remains preliminary." },
    { label: "NSE final-day opening display", value: "2,91,02,500 shares / 0.1158×", context: "NSE's current-issue endpoint was unchanged at the approximately 6:11 a.m. IST 19 August checkpoint. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE pre-session demand snapshot", value: "35,09,920 bids / 0.1270×", context: "Official category book timestamped 4:51:19 a.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: QIB 0.0041×, NII 0.2843× and retail 0.1298×. It is a later processing snapshot than the prior close view, not new second-session demand." },
    { label: "NSE pre-session demand display", value: "64,71,840 bids / 0.2342×", context: "NSE carried the same value from the 18 August evening check into the 19 August pre-session check. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE pre-session demand snapshot", value: "66,36,096 bids / 1.2096×", context: "Official category book timestamped 4:51:19 a.m. IST on 19 August against the 54,86,051-share post-anchor pool: QIB 0.0206×, NII 1.9920× and retail 1.5538×. It is a later processing snapshot than the prior close view, not new second-session demand." },
    { label: "NSE pre-session demand display", value: "1,74,64,319 bids / 3.1834×", context: "NSE carried the same value from the 18 August evening check into the 19 August pre-session check. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed." },
  ],
  strengths: [
