...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "68,50,560 bids / 0.2479×", context: "Official category book at 4:08:49 p.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: 14,45,600 QIB, 21,18,240 NII and 32,86,720 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "1,71,07,680 bids / 0.6190×", context: "Official current-issue endpoint at approximately 4:10 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7889 at 4:11:04 p.m. IST still showed 18–20 August bidding, ₹88–₹93, a 160-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "2,47,45,345 bids / 4.5106×", context: "Official category book at 4:08:49 p.m. IST on 19 August against the 54,86,051-share post-anchor pool: 1,21,360 QIB, 1,08,46,386 NII and 1,37,77,599 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "6,56,00,451 bids / 11.9577×", context: "Official current-issue endpoint at approximately 4:10 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7892 at 4:11:04 p.m. IST still showed 18–20 August bidding, ₹342–₹360, a 41-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day live book", value: "80,33,154 bids / 0.3172×", context: "Official 4:08:49 p.m. IST snapshot against 2,53,28,946 displayed shares: 6,33,981 QIB, 22,08,285 NII and 51,90,888 retail shares bid. The denominator uses the floor-price maximum; this remains an intraday, preliminary book." },
    { label: "NSE opening-day live display", value: "1,03,73,592 bids / 0.4096×", context: "Official current-issue endpoint at approximately 4:10 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7895 at 4:11:04 p.m. IST still showed 19–21 August bidding, ₹152–₹160, a 93-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
