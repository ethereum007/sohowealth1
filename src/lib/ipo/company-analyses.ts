...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "NSE issue price and listing", value: "₹118 / 19 Aug", context: "NSE's official past-issues table confirms both fields. The approximately 8:10 a.m. IST pre-market freeze still had no first trading outcome." },
  ],
  strengths: [
  ...
  slug: "ens-enterprises-ipo", company: "ENS Enterprises", market: "SME", sector: "Digital commerce, software engineering and SaaS", status: "Bidding closed; BSE post-close book 12.2678×; allotment pending", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "BSE post-close demand book", value: "3,16,06,800 bids / 12.2678×", context: "Official 6:59:28 p.m. IST 18 August book against 25,76,400 displayed post-anchor shares: QIB 9.4368×, NII 17.1813× and retail 11.0341×. The pool still includes 1,81,200 market-maker shares; demand equals approximately 13.20× the 23,95,200-share residual public pool by calculation. Issue-price and allotment reconciliation remain pending." },
  ...
  monitor: [
    ...
    "Issue price, basis of allotment and listing notices after BSE's 12.2678× post-close category book and the 10,26,000-share anchor allocation; reconcile the final price with the 3,15,30,000-share cap-price curve.",
  ...
  metrics: [
    ...
    { label: "BSE post-close demand book", value: "62,55,75,000 bids / 189.2241×", context: "Official 6:59:28 p.m. IST 18 August book against 33,06,000 displayed post-anchor shares: QIB 169.5359×, NII 231.3513× and retail 176.0455×. The pool still includes 2,31,000 market-maker shares; demand equals approximately 203.44× the 30,75,000-share residual public pool by calculation. Issue-price and allotment reconciliation remain pending." },
