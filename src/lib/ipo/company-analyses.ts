...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  slug: "behari-lal-engineering-ipo", company: "Behari Lal Engineering", market: "Mainboard", sector: "Specialty steel, metal rolls and engineering castings", status: "Listed 19 August 2026; NSE opened at ₹465 and BSE at ₹458 versus ₹285 issue price", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE / BSE opening price", value: "₹465 / ₹458", context: "Official special pre-open values, equal to +63.16% and +60.70% versus the ₹285 issue price. The exchanges can discover different opening prices before normal trading begins." },
  ],
  strengths: [
  ...
  monitor: [
    ...
    "Post-listing delivery, liquidity and price convergence after the ₹465 NSE and ₹458 BSE special pre-open prices; the final seller-by-seller OFS allocation, exact post-issue promoter holding, related-party transactions and fresh-proceeds deployment.",
  ],
  valuation: [
    "At the confirmed ₹285 issue price, BSE's 4,23,02,482 post-issue shares imply a market capitalisation of about ₹1,205.62 crore and a dilution-consistent FY26 P/E near 18.65×. The ₹465 NSE opening price implies approximately ₹1,967.07 crore and 30.43×, while the ₹458 BSE opening price implies ₹1,937.45 crore and 29.97×. These are opening-market snapshots, not assessments of fundamental fair value.",
  ...
  sources: [
    ...
    { label: "BSE Behari Lal opening-price quote feed", href: "https://api.bseindia.com/BseIndiaAPI/api/getScripHeaderData/w?scripcode=544870", kind: "Primary" },
    { label: "NSE Behari Lal opening-price quote proxy", href: "https://www.nseindia.com/api/NextApi/apiClient/GetQuoteApi?functionName=getSymbolData&marketType=N&series=EQ&symbol=BLEL", kind: "Primary" },
  ...
  slug: "shiprocket-ipo", company: "Shiprocket", market: "Mainboard", sector: "E-commerce enablement and logistics technology", status: "Listed 19 August 2026; NSE opened at ₹131 and BSE at ₹129.50 versus ₹97 issue price", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE / BSE opening price", value: "₹131 / ₹129.50", context: "Official special pre-open values, equal to +35.05% and +33.51% versus the ₹97 issue price. The exchanges can discover different opening prices before normal trading begins." },
  ],
  strengths: [
  ...
  monitor: [
    ...
    "Post-listing delivery, liquidity and price convergence after the ₹131 NSE and ₹129.50 BSE special pre-open prices.",
  ...
  valuation: [
    ...
    "The final prospectus shows 72,75,77,587 post-offer shares. At ₹97 this implies market capitalisation of ₹7,057.69 crore and the issuer-disclosed FY26 market-cap-to-revenue multiple of 3.49×. The ₹131 NSE opening price implies approximately ₹9,531.27 crore and 4.71× revenue, while the ₹129.50 BSE opening price implies ₹9,422.13 crore and 4.65× revenue.",
    "Offer price is about 2.93× the post-offer NAV of ₹33.12; the exchange opening prices are approximately 3.91–3.96× that NAV. P/E and EV/EBITDA are not meaningful because FY26 EPS and statutory EBITDA were negative.",
  ...
  sources: [
    ...
    { label: "BSE Shiprocket opening-price quote feed", href: "https://api.bseindia.com/BseIndiaAPI/api/getScripHeaderData/w?scripcode=544871", kind: "Primary" },
    { label: "NSE Shiprocket opening-price quote proxy", href: "https://www.nseindia.com/api/NextApi/apiClient/GetQuoteApi?functionName=getSymbolData&marketType=N&series=EQ&symbol=SHIPROCKET", kind: "Primary" },
  ...
  slug: "lalithaa-jewellery-mart-ipo", company: "Lalithaa Jewellery Mart", market: "Mainboard", sector: "Organised jewellery retail", status: "Bidding window ended 19 August 2026; final exchange reconciliation pending", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "BSE post-window reconciliation snapshot", value: "1,01,26,69,280 shares / 16.1352×", context: "Official category book timestamped 6:10:32 p.m. IST on 19 August against the 6,27,61,403-share post-anchor exchange pool: 79,00,02,022 QIB, 14,63,41,586 NII, 7,58,73,088 retail and 4,52,584 employee shares bid. The book continued to change after 5 p.m., so this is a later preliminary exchange snapshot rather than final reconciled subscription." },
    { label: "NSE post-window reconciliation display", value: "2,93,95,16,726 shares / 46.8364×", context: "Official current-issue endpoint retrieved at 6:12:03 p.m. IST on 19 August still labelled the issue Active and had not moved it to the past-issues table. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together or described as final." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7886 rechecked at 6:11:19 p.m. IST still showed 17–19 August bidding, ₹190–₹201, a 74-share minimum and blank post-issue modification, addendum, corrigendum, public-notice and remarks fields." },
  ...
  slug: "horizon-industrial-parks-ipo", company: "Horizon Industrial Parks", market: "Mainboard", sector: "Industrial and logistics real estate", status: "Bidding window ended 19 August 2026; final exchange reconciliation pending", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "BSE post-window reconciliation snapshot", value: "13,66,86,750 shares / 0.5438×", context: "Official category book timestamped 6:10:32 p.m. IST on 19 August against the 25,13,56,273-share post-anchor exchange pool: 11,13,62,500 QIB, 1,45,26,000 NII, 1,05,48,500 retail and 2,49,750 employee shares bid. The book continued to change after 5 p.m., so this is a later preliminary exchange snapshot rather than final reconciled subscription." },
    { label: "NSE post-window reconciliation display", value: "22,71,11,250 shares / 0.9035×", context: "Official current-issue endpoint retrieved at 6:12:03 p.m. IST on 19 August still labelled the issue Active and had not moved it to the past-issues table. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together or described as final." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7890 rechecked at 6:11:19 p.m. IST still showed 17–19 August bidding, ₹57–₹60, a 250-share minimum and blank post-issue modification, addendum, corrigendum, public-notice and remarks fields." },
  ],
  strengths: [
  ...
  slug: "shankesh-jewellers-ipo", company: "Shankesh Jewellers", market: "Mainboard", sector: "B2B handcrafted gold jewellery", status: "Issue active; scheduled to close 20 August 2026", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE second-session post-window display", value: "1,87,07,520 bids / 0.6769×", context: "Official current-issue endpoint retrieved at 5:44:12 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together, and neither is final while bidding remains active." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7889 rechecked at 5:43:54 p.m. IST still showed 18–20 August bidding, ₹88–₹93, a 160-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
  ...
  slug: "sunshine-pictures-ipo", company: "Sunshine Pictures", market: "Mainboard", sector: "Film, television and digital content production", status: "Issue active; scheduled to close 20 August 2026", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE second-session post-window display", value: "7,50,00,070 bids / 13.6710×", context: "Official current-issue endpoint retrieved at 5:44:12 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together, and neither is final while bidding remains active." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7892 rechecked at 5:43:54 p.m. IST still showed 18–20 August bidding, ₹342–₹360, a 41-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
  ...
  slug: "gaja-alternative-asset-management-ipo", company: "Gaja Alternative Asset Management", market: "Mainboard", sector: "Private equity and alternative asset management", status: "Issue active; bidding opens 19 August 2026 and closes 21 August 2026", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE opening-day post-window display", value: "1,27,24,353 bids / 0.5024×", context: "Official current-issue endpoint retrieved at 5:44:12 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together, and neither is final while bidding remains active." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7895 rechecked at 5:43:54 p.m. IST still showed 19–21 August bidding, ₹152–₹160, a 93-share minimum and blank addendum, corrigendum and remarks fields." },
  ],
  strengths: [
  ...
  slug: "fascinate-textiles-ipo", company: "Fascinate Textiles", market: "SME", sector: "Readymade garment manufacturing", status: "Extended bidding window ended 19 August 2026; final NSE reconciliation pending", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE post-window reconciliation snapshot", value: "62,39,200 bids / 1.45×", context: "Official feed retrieved at 6:12:03 p.m. IST on 19 August against the 42,93,600-share displayed gross offer still labelled the issue Active. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.53× the residual 40,78,400-share public pool by calculation. This is not a final category-wise figure." },
    { label: "NSE exchange-transition recheck", value: "Still Active; absent from past issues", context: "At 6:12:03 p.m. IST, the current feed still showed the extended 19 August end date and NSE's official past-issues table did not yet contain Fascinate. Final category demand, allotment and the revised listing timetable still require controlling exchange notices." },
  ...
  slug: "qt-foods-ipo", company: "Q&T Foods", market: "SME", sector: "Fresh bakery products", status: "Listed 19 August 2026 on BSE SME; opened at ₹115, flat to issue price", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "BSE opening price", value: "₹115 / 0.00%", context: "Official 19 August 9:45 a.m. IST quote header matched the issue price; BSE recorded 1,95,600 shares and ₹2.24 crore turnover at the opening checkpoint." },
  ...
  valuation: [
    "BSE notice 20260818-34 confirms 70,77,200 post-allotment shares, one 1,200-share lot below the prospectus's 70,78,400 fully subscribed assumption. The ₹115 special pre-open opening price was flat to issue price and implies BSE's reported ₹81.39 crore full market capitalisation, or about 15.7× FY26 PAT of ₹5.20 crore.",
  ...
  sources: [
    ...
    { label: "BSE Q&T opening-price quote feed", href: "https://api.bseindia.com/BseIndiaAPI/api/getScripHeaderData/w?scripcode=544872", kind: "Primary" },
    { label: "IPOPlatform Q&T offer and proceeds summary", href: "https://www.ipoplatform.com/ipo/qandt-foods-ipo/4693", kind: "Secondary" },
  ],
}, {
  slug: "pramodini-medicare-ipo", company: "Pramodini Medicare", market: "SME", sector: "Diagnostic imaging, laboratory and nuclear-medicine services", status: "Listed 19 August 2026 on NSE Emerge; opened at ₹120 versus ₹118 issue price", analysisAsOf: "19 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE opening price", value: "₹120 / +1.69%", context: "Official 19 August 9:56 a.m. IST special pre-open snapshot versus the ₹118 issue price; NSE recorded 13,00,800 shares and ₹15.61 crore of value." },
  ],
  strengths: [
  ...
  monitor: [
    ...
    "Post-listing liquidity and price stability after the ₹120 NSE Emerge opening price, final basis of allotment, acquisition deployment, related-party transactions and promoter remuneration.",
  ...
  valuation: [
    "The RHP confirms 2,20,45,595 post-offer shares. At the ₹118 final issue price, this implies approximately ₹260.14 crore market capitalisation and about 15.0× FY26 PAT of ₹17.38 crore. The ₹120 NSE Emerge opening price implies approximately ₹264.55 crore and 15.22× trailing PAT; this is an opening-market snapshot, not an assessment of fundamental fair value.",
  ...
  sources: [
    ...
    { label: "NSE current IPO issue feed", href: "https://www.nseindia.com/api/ipo-current-issue", kind: "Primary" },
    { label: "NSE past public issues table", href: "https://www.nseindia.com/api/public-past-issues", kind: "Primary" },
    { label: "NSE Pramodini opening-price quote proxy", href: "https://www.nseindia.com/api/NextApi/apiClient/GetQuoteApi?functionName=getSymbolData&marketType=N&series=ST&symbol=PRAMODINI", kind: "Primary" },
  ...
  metrics: [
    ...
    { label: "Cap price / pre-issue NAV", value: "5.71×", context: "Derived from the ₹189 cap and the RHP's ₹33.12 FY26 weighted-average NAV per share; the RHP leaves after-issue NAV blank." },
  ...
  valuation: [
    "At the ₹189 cap, the arithmetically reconciled 1,82,22,900 post-issue shares imply an equity value of approximately ₹344.41 crore, or about 18.7× FY26 PAT of ₹18.45 crore. The RHP's printed 1,87,86,900 total would instead imply ₹355.07 crore and 19.3×, but it is 5,64,000 shares above disclosed pre-issue shares plus fresh shares and is therefore not used as the base case pending correction.",
    "The cap is 5.71× the RHP's ₹33.12 FY26 weighted-average NAV. Adding the ₹93.90 crore gross fresh issue to ₹43.79 crore FY26 net worth gives an illustrative ₹75.56 gross post-issue book value per reconciled share, or 2.50× price-to-book before issue expenses; the RHP itself leaves after-issue NAV blank.",
