...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "41,64,49,282 shares / 6.6354×", context: "Official 2:42:07 p.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 22,58,69,756 QIB, 12,85,82,474 NII, 6,15,98,044 retail and 3,99,008 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "1,39,37,48,856 shares / 22.2071×", context: "Official current-issue endpoint at approximately 2:40 p.m. IST on 19 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "8,69,43,500 shares / 0.3459×", context: "Official 2:42:07 p.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 7,13,44,500 QIB, 68,87,750 NII, 84,82,000 retail and 2,29,250 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "14,76,98,000 shares / 0.5876×", context: "Official current-issue endpoint at approximately 2:40 p.m. IST on 19 August. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day live snapshot", value: "57,26,400 bids / 1.33×", context: "Official feed at approximately 2:40 p.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.40× the residual 40,78,400-share public pool by calculation. This is an intraday aggregate, not a final category-wise figure." },
