...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE opening-day mid-afternoon demand", value: "16,27,200 bids / 0.0589×", context: "Official 3:05:50 p.m. IST 18 August category-book snapshot against the 2,76,37,400-share post-anchor public pool: QIB 0.0000×, NII 0.0213× and retail 0.1086×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day mid-afternoon demand display", value: "53,35,040 bids / 0.1930×", context: "NSE's current-issue endpoint rechecked separately at approximately 3:06 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day mid-afternoon demand", value: "49,88,388 bids / 0.9093×", context: "Official 3:05:50 p.m. IST 18 August category-book snapshot against the 54,86,051-share post-anchor public pool: QIB 0.0148×, NII 1.5106× and retail 1.1627×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day mid-afternoon demand display", value: "1,26,50,591 bids / 2.3060×", context: "NSE's current-issue endpoint rechecked separately at approximately 3:06 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
