...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. BSE's category snapshot at 10:28 IST on 17 August records 13,45,616 shares bid for, or 0.0214× the displayed pool. This is an intraday observation rather than a final demand reading.",
  ...
  metrics: [
    ...
    { label: "BSE intraday demand", value: "13,45,616 shares / 0.0214×", context: "Official 10:28 IST snapshot on 17 August against the 6,27,61,403-share post-anchor exchange pool: 3,63,932 NII, 9,53,786 retail, 27,898 employee and no QIB bids yet. The book remains preliminary and can change through the issue period." },
  ...
  metrics: [
    ...
    { label: "BSE intraday demand", value: "8,03,750 shares / 0.0032×", context: "Official 10:28 IST snapshot on 17 August against the 25,13,56,273-share post-anchor exchange pool: 1,70,000 NII, 6,26,500 retail, 7,250 employee and no QIB bids yet. The book remains preliminary and can change through the issue period." },
  ],
  strengths: [
