...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  slug: "qt-foods-ipo", company: "Q&T Foods", market: "SME", sector: "Fresh bakery products", status: "Listing confirmed for 19 August 2026 at ₹115 on BSE SME", analysisAsOf: "18 August 2026",
  ...
  valuation: [
    "BSE notice 20260818-34 confirms 70,77,200 post-allotment shares, correcting the earlier 70,78,400-share prospectus-based count. At ₹115, this implies approximately ₹81.39 crore market capitalisation and about 15.7× FY26 PAT of ₹5.20 crore.",
  ...
  slug: "pramodini-medicare-ipo", company: "Pramodini Medicare", market: "SME", sector: "Diagnostic imaging, laboratory and nuclear-medicine services", status: "Issue closed; NSE still shows final price and listing as unavailable", analysisAsOf: "18 August 2026",
  ...
  issueNote: "The 4 August RHP confirms 58,51,200 shares: 53,50,800 fresh shares, 5,00,400 OFS shares and a 3,36,000-share market-maker reservation, leaving a 55,15,200-share net offer. At the ₹118 cap this implies up to ₹69.04 crore, including ₹63.14 crore fresh and ₹5.90 crore OFS. The market lot is 1,200 shares, but the RHP requires a two-lot minimum application, or 2,400 shares. NSE's past-issues table lists Pramodini, correcting the earlier transition state in which it was absent from both exchange feeds. At the approximately 11:40 p.m. IST recheck on 18 August, that official table still showed dashes for final issue price and listing date, so demand, allotment and the RHP's proposed 19 August listing remain unconfirmed.",
  ...
  metrics: [
    ...
    { label: "NSE exchange status", value: "Past issues; fields blank", context: "The official 18 August late-evening recheck still showed dashes for final issue price and listing date; the proposed 19 August listing is not treated as confirmed." },
  ],
  strengths: [
  ...
  slug: "skytech-infinite-platform-ipo", company: "Skytech Infinite Platform", market: "SME", sector: "Industrial automation, control panels and turnkey engineering", status: "Issue closed; absent from NSE current and past issue tables at late 18 August recheck", analysisAsOf: "18 August 2026",
  ...
  issueNote: "The 9 August RHP confirms an entirely fresh issue of up to 29,45,600 shares, including a 1,48,800-share market-maker reservation and a 27,96,800-share net issue, with bidding from 14–18 August. The lead manager's official price advertisement sets a ₹73–₹77 band and a minimum bid of 3,200 shares, with subsequent bids in multiples of 1,600. That minimum application is ₹2,33,600–₹2,46,400. NSE's last readable current-issue snapshot at approximately 9:35 p.m. IST on 18 August still marked the issue Active and recorded 58,57,600 bids against 29,45,600 displayed gross-offer shares, or 1.99×. The displayed denominator includes the 1,48,800-share market-maker reservation; against the residual 27,96,800-share public pool, the same demand is approximately 2.09× by calculation. At the approximately 11:40 p.m. IST recheck, Skytech had left NSE's current-issue feed but was still absent from the official past-issues table. That confirms an exchange transition, not a reconciled or category-wise subscription book; final price, allotment and listing remain unavailable.",
  ...
  metrics: [
    ...
    { label: "NSE exchange transition", value: "Absent from both tables", context: "By approximately 11:40 p.m. IST on 18 August, Skytech was no longer in NSE's current feed but had not appeared in the public past-issues table; final price and listing remain unavailable." },
