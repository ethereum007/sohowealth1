...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE opening-day late-afternoon demand", value: "33,50,400 bids / 0.1212×", context: "Official 4:35:50 p.m. IST 18 August category-book snapshot against the 2,76,37,400-share post-anchor public pool: QIB 0.0041×, NII 0.2804× and retail 0.1199×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day late-afternoon demand display", value: "63,44,960 bids / 0.2296×", context: "NSE's current-issue endpoint rechecked separately at approximately 4:36 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day late-afternoon demand", value: "61,17,200 bids / 1.1150×", context: "Official 4:35:50 p.m. IST 18 August category-book snapshot against the 54,86,051-share post-anchor public pool: QIB 0.0206×, NII 1.8982× and retail 1.4048×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day late-afternoon demand display", value: "1,68,82,037 bids / 3.0773×", context: "NSE's current-issue endpoint rechecked separately at approximately 4:36 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
