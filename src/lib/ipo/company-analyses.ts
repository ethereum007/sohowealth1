...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  monitor: [
    ...
    "Issue price, basis of allotment and listing notices after BSE's 12.2678× post-close category book and the 10,26,000-share anchor allocation.",
  ...
  monitor: [
    ...
    "Issue price, basis of allotment and listing notice after BSE's 189.2241× post-close category book.",
