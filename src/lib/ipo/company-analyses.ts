...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. BSE's post-open category snapshot at 10:07 IST on 17 August records 3,87,094 shares bid for, or 0.0062× the displayed pool. This is an opening-book observation rather than a final demand reading.",
  ...
  metrics: [
    ...
    { label: "BSE opening-book demand", value: "3,87,094 shares / 0.0062×", context: "Official 10:07 IST snapshot on 17 August against the 6,27,61,403-share post-anchor exchange pool: 2,04,610 NII, 1,82,188 retail, 296 employee and no QIB bids yet. This very early mix is preliminary." },
  ...
  metrics: [
    ...
    { label: "BSE opening-book demand", value: "2,62,000 shares / 0.0010×", context: "Official 10:07 IST snapshot on 17 August against the 25,13,56,273-share post-anchor exchange pool: 1,22,000 NII, 1,36,500 retail, 3,500 employee and no QIB bids yet. This very early mix is preliminary." },
  ],
  strengths: [
