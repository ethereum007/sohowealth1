...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "66,97,440 bids / 0.2423×", context: "Official category book at 3:11:36 p.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: 14,45,600 QIB, 20,96,960 NII and 31,54,880 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "1,57,07,360 bids / 0.5683×", context: "Official current-issue endpoint at approximately 3:10 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7889 at 3:11:39 p.m. IST still showed 18–20 August bidding, ₹88–₹93, a 160-share minimum and blank addendum and corrigendum fields." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "2,30,80,991 bids / 4.2072×", context: "Official category book at 3:11:36 p.m. IST on 19 August against the 54,86,051-share post-anchor pool: 1,18,572 QIB, 99,96,415 NII and 1,29,66,004 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "6,15,09,020 bids / 11.2119×", context: "Official current-issue endpoint at approximately 3:10 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7892 at 3:11:39 p.m. IST still showed 18–20 August bidding, ₹342–₹360, a 41-share minimum and blank addendum and corrigendum fields." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day live book", value: "71,40,912 bids / 0.2819×", context: "Official 3:11:36 p.m. IST snapshot against 2,53,28,946 displayed shares: 6,27,657 QIB, 18,21,963 NII and 46,91,292 retail shares bid. The denominator uses the floor-price maximum; this remains an intraday, preliminary book." },
    { label: "NSE opening-day live display", value: "94,54,194 bids / 0.3733×", context: "Official current-issue endpoint at approximately 3:10 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
    { label: "BSE issue-record recheck", value: "No addendum or corrigendum", context: "Official issue record 7895 at 3:11:39 p.m. IST still showed 19–21 August bidding, ₹152–₹160, a 93-share minimum and blank addendum and corrigendum fields." },
  ],
  strengths: [
