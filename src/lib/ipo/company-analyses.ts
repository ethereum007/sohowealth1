...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "NSE final-day mid-afternoon demand", value: "52,52,800 bids / 1.78×", context: "Official feed rechecked at approximately 3:06 p.m. IST on 18 August against the 29,45,600-share displayed gross offer. Because that denominator includes 1,48,800 market-maker shares, demand is approximately 1.88× the residual 27,96,800-share public pool by calculation. The reading remains interim and is not category-wise." },
