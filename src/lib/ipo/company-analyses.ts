...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "NSE second-session post-window display", value: "1,87,07,520 bids / 0.6769×", context: "Official current-issue endpoint rechecked at approximately 8:25 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together, and neither is final while bidding remains active." },
  ...
  metrics: [
    ...
    { label: "NSE second-session post-window display", value: "7,50,00,070 bids / 13.6710×", context: "Official current-issue endpoint rechecked at approximately 8:25 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together, and neither is final while bidding remains active." },
  ...
  metrics: [
    ...
    { label: "NSE opening-day post-window display", value: "1,27,24,353 bids / 0.5024×", context: "Official current-issue endpoint rechecked at approximately 8:25 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together, and neither is final while bidding remains active." },
