...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final prospectus dated 6 August and BSE issue 7883 confirm an entirely fresh fixed-price issue of 22,82,400 shares at ₹115, aggregating to ₹26.2476 crore. This includes a 1,15,200-share market-maker reservation and a 21,67,200-share net issue. The market lot is 1,200 shares, while the minimum application is two lots, or 2,400 shares. Issue expenses are estimated at ₹3.66 crore, leaving ₹22.59 crore net proceeds. Final allotment and BSE SME listing notices remain controlling.",
