...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "6,09,49,878 shares / 0.9711×", context: "Official 10:11:55 a.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 1,80,60,514 QIB, 2,07,67,878 NII, 2,18,69,664 retail and 2,51,822 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "17,83,46,956 shares / 2.8417×", context: "Official current-issue endpoint at approximately 10:10 a.m. IST on 19 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "3,09,02,750 shares / 0.1229×", context: "Official 10:11:55 a.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,83,250 QIB, 11,96,750 NII, 53,60,000 retail and 1,62,750 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "3,35,28,250 shares / 0.1334×", context: "Official current-issue endpoint at approximately 10:10 a.m. IST on 19 August. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "40,79,200 bids / 0.1476×", context: "Official category book at 10:40:07 a.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: 32,640 QIB, 18,49,920 NII and 21,96,640 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "80,89,920 bids / 0.2927×", context: "Official current-issue endpoint at approximately 10:40 a.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "1,06,59,795 bids / 1.9431×", context: "Official category book at 10:40:07 a.m. IST on 19 August against the 54,86,051-share post-anchor pool: 47,970 QIB, 43,77,816 NII and 62,34,009 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "2,69,33,638 bids / 4.9095×", context: "Official current-issue endpoint at approximately 10:40 a.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day live book", value: "14,66,052 bids / 0.0579×", context: "Official 10:40:07 a.m. IST snapshot against 2,53,28,946 displayed shares: nil QIB, 4,42,308 NII and 10,23,744 retail shares bid. The denominator uses the floor-price maximum; this remains an intraday, preliminary book." },
    { label: "NSE opening-day live display", value: "15,77,001 bids / 0.0623×", context: "Official current-issue endpoint at approximately 10:40 a.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day live snapshot", value: "41,52,000 bids / 0.97×", context: "Official feed at approximately 10:10 a.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.02× the residual 40,78,400-share public pool by calculation. This is an intraday aggregate, not a final category-wise figure." },
