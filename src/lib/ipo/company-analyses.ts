...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "62,59,200 bids / 0.2265×", context: "Official category book at 1:12:26 p.m. IST on 19 August against the 2,76,37,400-share post-anchor pool: 14,43,360 QIB, 20,16,160 NII and 27,99,680 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "1,28,50,080 bids / 0.4650×", context: "Official current-issue endpoint at approximately 1:10 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE second-session live book", value: "1,84,36,798 bids / 3.3607×", context: "Official category book at 1:12:26 p.m. IST on 19 August against the 54,86,051-share post-anchor pool: 95,284 QIB, 79,20,708 NII and 1,04,20,806 retail shares bid. This remains an intraday, preliminary book." },
    { label: "NSE second-session live display", value: "4,77,74,307 bids / 8.7083×", context: "Official current-issue endpoint at approximately 1:10 p.m. IST on 19 August. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day live book", value: "48,63,435 bids / 0.1920×", context: "Official 1:12:26 p.m. IST snapshot against 2,53,28,946 displayed shares: 2,604 QIB, 14,76,003 NII and 33,84,828 retail shares bid. The denominator uses the floor-price maximum; this remains an intraday, preliminary book." },
    { label: "NSE opening-day live display", value: "68,96,880 bids / 0.2723×", context: "Official current-issue endpoint at approximately 1:10 p.m. IST on 19 August against the same displayed share count. It is kept separate from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
