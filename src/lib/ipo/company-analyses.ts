...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE day-two morning demand", value: "2,82,70,250 shares / 0.1125×", context: "Official 11:06:15 a.m. IST snapshot on 18 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,33,000 QIB, 6,20,000 NII, 34,16,750 retail and 1,00,500 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE day-two morning demand display", value: "1,23,67,750 shares / 0.0492×", context: "NSE's current-issue endpoint frozen separately at approximately 11:06 a.m. IST on 18 August. Its materially lower reading is preserved as a separate exchange view because the aggregation basis is not confirmed; the feeds are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day demand", value: "7,26,880 bids / 0.0263×", context: "Official 11:33:53 a.m. IST 18 August category-book snapshot against the 2,76,37,400-share post-anchor public pool: QIB 0.0000×, NII 0.0077× and retail 0.0493×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day demand display", value: "25,36,160 bids / 0.0918×", context: "NSE's current-issue endpoint frozen separately at approximately 11:36 a.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE opening-day demand", value: "16,29,914 bids / 0.2971×", context: "Official 11:33:53 a.m. IST 18 August category-book snapshot against the 54,86,051-share post-anchor public pool: QIB 0.0025×, NII 0.4498× and retail 0.4000×. The issue remains open through 20 August and the reading is preliminary." },
    { label: "NSE opening-day demand display", value: "43,10,658 bids / 0.7857×", context: "NSE's current-issue endpoint frozen separately at approximately 11:36 a.m. IST on 18 August. It is shown separately from BSE's category book because the exchange aggregation basis is not confirmed; the two readings are not added together." },
  ],
  strengths: [
