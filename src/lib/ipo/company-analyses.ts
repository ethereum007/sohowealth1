...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "11,24,63,794 shares / 1.7919×", context: "Official 11:41:26 a.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 1,85,12,210 QIB, 5,73,73,236 NII, 3,62,58,668 retail and 3,19,680 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "41,70,63,038 shares / 6.6452×", context: "Official current-issue endpoint at approximately 11:41 a.m. IST on 19 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day live book", value: "3,28,58,500 shares / 0.1307×", context: "Official 11:41:26 a.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,86,750 QIB, 17,02,750 NII, 67,85,750 retail and 1,83,250 employee shares bid. This remains an intraday, preliminary book." },
    { label: "NSE final-day live display", value: "4,17,38,500 shares / 0.1661×", context: "Official current-issue endpoint at approximately 11:41 a.m. IST on 19 August. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "NSE final-day live snapshot", value: "46,34,400 bids / 1.08×", context: "Official feed at approximately 11:41 a.m. IST on 19 August against the 42,93,600-share displayed gross offer. Because that denominator includes 2,15,200 market-maker shares, demand is approximately 1.14× the residual 40,78,400-share public pool by calculation. This is an intraday aggregate, not a final category-wise figure." },
