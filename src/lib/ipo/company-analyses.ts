...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The 10 August RHP and the official 11 August price-band advertisement confirm 3,94,82,000 shares: 2,94,82,000 fresh shares and 1,00,00,000 OFS shares sold by promoters Kantilal Kheemraj Jain and Manoj Kantilal Jain. The ₹88–₹93 band, 160-share lot and 18–20 August bidding are primary-source verified; the minimum application at the cap is ₹14,880. BSE issue record 7889 corrected its earlier one-share placeholder and showed the 160-share lot at the 18:33 IST recheck on 17 August. At ₹93, the offer is approximately ₹367.18 crore, split into ₹274.18 crore fresh and ₹93 crore OFS. BSE notice 20260817-31 confirms 1,18,44,600 anchor shares subscribed at ₹93 on 17 August, equal to approximately ₹110.15 crore and exactly 30% of the gross offer. NSE subsequently displayed 2,76,37,400 shares as the post-anchor public bid pool for the 18 August opening. No addendum or corrigendum was present in BSE issue record 7889 at the recheck.",
  ...
  slug: "credent-connect-n-care-ipo", company: "Credent Connect N Care", market: "SME", sector: "Healthcare logistics, workforce and diagnostic support services", status: "Scheduled close reached 17 August; final NSE notices pending", analysisAsOf: "17 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE scheduled-close snapshot", value: "142.38×", context: "50,74,31,400 shares bid against a 35,64,000-share post-anchor public pool at the 8:59 p.m. IST 17 August recheck; NSE still labelled the issue active, so final reconciliation remains pending." },
  ...
  issueNote: "The 9 August RHP confirms an entirely fresh issue of up to 29,45,600 shares, including a 1,48,800-share market-maker reservation and a 27,96,800-share net issue, with bidding from 14–18 August. The lead manager's official price advertisement sets a ₹73–₹77 band and a minimum bid of 3,200 shares, with subsequent bids in multiples of 1,600. That minimum application is ₹2,33,600–₹2,46,400. NSE's feed rechecked at 8:59 p.m. IST on 17 August still showed 27,50,400 bids against 29,45,600 displayed offer shares, or 0.93×. That exchange display uses the gross offer including the market-maker reservation, so it is a provisional total-demand reading and should not be confused with final category-wise subscription. Final price, allotment and listing remain subject to NSE Emerge notices.",
  ...
  metrics: [
    ...
    { label: "NSE live demand snapshot", value: "0.93×", context: "27,50,400 bids versus the 29,45,600-share exchange-displayed gross offer at the 8:59 p.m. IST 17 August recheck; the issue closes on 18 August and this is not a final category-wise figure." },
