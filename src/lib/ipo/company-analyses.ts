...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The final RHP dated 9 August and price-band advertisement confirm a ₹1,700 crore offer: ₹1,200 crore fresh issue plus ₹500 crore promoter OFS, a ₹190–₹201 band and a 74-share minimum lot. The minimum application at the cap is ₹14,874. An employee reservation of up to ₹6 crore carries a ₹19 discount. The Regulation 6(1) offer makes up to 50% of the net offer available to QIBs, at least 15% to non-institutional bidders and at least 35% to retail bidders. BSE's 14 August anchor notice confirms allocation of 2,52,83,581 shares at ₹201, equal to ₹508.20 crore. NSE and BSE then show 6,27,61,403 shares for public bidding; that post-anchor exchange pool does not replace the original ₹1,700 crore gross offer. At 1:38:59 p.m. IST on 18 August, BSE's category book showed 3,42,31,882 bids, or 0.5454×: QIB 0.6699×, NII 0.6399×, retail 0.4331× and employee 0.6059×. NSE's current-issue endpoint, rechecked separately at approximately 1:39 p.m., displayed 8,03,51,124 bids, or 1.2803× against the same offered-share count. The exchange views are retained separately rather than added because their aggregation basis is not confirmed; bidding continues through 19 August and both readings remain preliminary.",
  ...
  metrics: [
    ...
    { label: "BSE day-two early-afternoon demand", value: "3,42,31,882 shares / 0.5454×", context: "Official 1:38:59 p.m. IST snapshot on 18 August against the 6,27,61,403-share post-anchor exchange pool: 1,19,46,264 QIB, 85,57,878 NII, 1,35,15,138 retail and 2,12,602 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE day-two early-afternoon demand display", value: "8,03,51,124 shares / 1.2803×", context: "NSE's current-issue endpoint rechecked separately at approximately 1:39 p.m. IST on 18 August. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE day-two early-afternoon demand", value: "2,92,02,250 shares / 0.1162×", context: "Official 1:38:59 p.m. IST snapshot on 18 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,33,000 QIB, 7,39,000 NII, 42,19,250 retail and 1,11,000 employee shares bid. The book remains preliminary and can change through the issue period." },
    { label: "NSE day-two early-afternoon demand display", value: "1,70,10,750 shares / 0.0677×", context: "NSE's current-issue endpoint frozen separately at approximately 1:39 p.m. IST on 18 August. Its materially lower reading is preserved as a separate exchange view because the aggregation basis is not confirmed; the feeds are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "BSE final-day early-afternoon demand", value: "19,46,50,000 bids / 58.8778×", context: "Official 1:05:48 p.m. IST 18 August snapshot against 33,06,000 displayed post-anchor shares: QIB 25.3854×, NII 85.9158× and retail 62.3121×. The pool still includes 2,31,000 market-maker shares; demand equals approximately 63.30× the residual public pool by calculation and remains interim." },
