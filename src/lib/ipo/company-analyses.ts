...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "Anchor notice status", value: "Not yet published", context: "BSE issue record 7895, its notice section and Gaja's official IPO-disclosures page contained no anchor allocation, addendum or corrigendum at the approximately 4:08 p.m. IST 18 August recheck. The scheduled anchor date is 18 August and the public issue opens 19 August." },
  ],
  strengths: [
  ...
  slug: "skytech-infinite-platform-ipo", company: "Skytech Infinite Platform", market: "SME", sector: "Industrial automation, control panels and turnkey engineering", status: "Issue active on final scheduled day; closes 18 August 2026", analysisAsOf: "18 August 2026",
