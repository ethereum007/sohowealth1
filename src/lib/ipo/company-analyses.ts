...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  concerns: [
    ...
    "Two promoter shareholders are selling while the company raises funds to repay debt. At the cap structure, Kantilal's holding falls to 2,42,64,000 shares and Manoj's to 2,61,74,000; the three promoters retain about 52.56%, and promoters plus promoter group about 69.53%. Control remains concentrated even after the OFS and fresh-issue dilution.",
  ...
  concerns: [
    ...
    "The OFS is approximately 39% of the issue. Vipul Shah offers up to 20,31,388 shares and Shefali Shah up to 10,05,769 shares, worth approximately ₹73.13 crore and ₹36.21 crore at the cap; the company receives no OFS proceeds. The family promoter group still retains about 74.84% on the cap-price share count, so creative, operating and voting control remains concentrated.",
  ...
  metrics: [
    ...
    { label: "Promoter-group holding at cap", value: "54.23%", context: "Derived cap-price illustration: promoters plus promoter group retain 7,64,70,184 of 14,10,10,230 post-offer shares. The promoters alone retain 46.97% after Ranjit and Imran sell ₹49.35 crore of shares." },
  ...
  concerns: [
    ...
    "The ₹100 crore OFS is being sold by eight shareholders. At the ₹160 cap, promoter sellers Ranjit Shah and Imran Jafar sell 30,84,375 shares worth ₹49.35 crore; six other sellers account for the remaining 31,65,625 shares. Promoters plus promoter group still retain about 54.23% on the cap-price post-offer count, while the promoters alone retain 46.97%. Low historic acquisition costs for several sellers make the cash-out and continuing-control mix relevant governance context.",
