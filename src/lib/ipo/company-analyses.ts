...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "5,36,16,996 shares / 0.8543×", context: "Official 4:17:35 a.m. IST snapshot on 19 August against the 6,27,61,403-share post-anchor exchange pool: 1,80,24,254 QIB, 1,53,18,666 NII, 2,00,26,546 retail and 2,47,530 employee shares bid. This is a pre-session carry-forward book and remains preliminary." },
    { label: "NSE final-day opening display", value: "14,04,15,518 shares / 2.2373×", context: "NSE's current-issue endpoint was unchanged at the approximately 4:17 a.m. IST 19 August checkpoint. It is shown separately from BSE's category book because the exchange-level aggregation basis is not confirmed; the two readings are not added together." },
  ...
  metrics: [
    ...
    { label: "BSE final-day opening snapshot", value: "3,05,45,000 shares / 0.1215×", context: "Official 4:17:35 a.m. IST snapshot on 19 August against the 25,13,56,273-share post-anchor exchange pool: 2,41,83,250 QIB, 11,01,000 NII, 51,23,250 retail and 1,37,500 employee shares bid. This is a pre-session carry-forward book and remains preliminary." },
    { label: "NSE final-day opening display", value: "2,91,02,500 shares / 0.1158×", context: "NSE's current-issue endpoint was unchanged at the approximately 4:17 a.m. IST 19 August checkpoint. It is preserved as a separate exchange view because the feeds are independently maintained; the readings are not added together." },
  ],
  strengths: [
  ...
  metrics: [
    ...
    { label: "Opening-day pre-market state", value: "Zero bids before market open", context: "At approximately 3:40 a.m. IST on 19 August, NSE marked Gaja Active but displayed zero offered shares and bids; BSE's untimestamped table showed zero bids against 2,53,28,946 shares. Neither is a demand reading. BSE's denominator uses the floor-price maximum, while the cap-price offer less the confirmed anchor allocation implies 2,40,62,500 shares." },
  ],
  strengths: [
