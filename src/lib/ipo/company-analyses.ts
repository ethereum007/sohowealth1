...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "NSE live demand snapshot", value: "0.54×", context: "23,04,800 bids versus the 42,93,600-share gross offer at the 8:56 a.m. IST 17 August recheck; not a final category-wise figure." },
  ...
  metrics: [
    ...
    { label: "NSE subscription snapshot", value: "11.23×", context: "4,00,10,400 shares bid against a 35,64,000-share post-anchor public pool at the 8:56 a.m. IST 17 August recheck; not a final close figure." },
  ...
  metrics: [
    ...
    { label: "NSE live demand snapshot", value: "0.42×", context: "12,38,400 bids versus the exchange-displayed gross offer at the 8:56 a.m. IST 17 August recheck; not a final category-wise figure." },
