...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  slug: "qt-foods-ipo", company: "Q&T Foods", market: "SME", sector: "Fresh bakery products", status: "Issue closed; no Q&T listing circular in BSE notices through 18 August", analysisAsOf: "18 August 2026",
  ...
  metrics: [
    ...
    { label: "NSE exchange transition", value: "Past issues; price/listing unavailable", context: "NSE's past public issues table listed Credent at the 8:06 a.m. IST 18 August recheck but still showed dashes for issue price and listing date." },
  ...
  slug: "skytech-infinite-platform-ipo", company: "Skytech Infinite Platform", market: "SME", sector: "Industrial automation, control panels and turnkey engineering", status: "Scheduled bidding period ended 18 August 2026; NSE feed still marked active pending rollover", analysisAsOf: "18 August 2026",
  ...
  issueNote: "The 9 August RHP confirms an entirely fresh issue of up to 29,45,600 shares, including a 1,48,800-share market-maker reservation and a 27,96,800-share net issue, with bidding from 14–18 August. The lead manager's official price advertisement sets a ₹73–₹77 band and a minimum bid of 3,200 shares, with subsequent bids in multiples of 1,600. That minimum application is ₹2,33,600–₹2,46,400. NSE's current-issue feed rechecked at approximately 9:35 p.m. IST on 18 August still marked the issue Active after the scheduled closing-day bidding window and recorded 58,57,600 bids against 29,45,600 displayed gross-offer shares, or 1.99×. The displayed denominator includes the 1,48,800-share market-maker reservation; against the residual 27,96,800-share public pool, the same demand is approximately 2.09× by calculation. Skytech was also absent from NSE's past-issues table at that recheck. The unresolved Active label and missing rollover mean this is not treated as a final reconciled or category-wise subscription book. Final price, allotment and listing remain subject to NSE Emerge notices.",
