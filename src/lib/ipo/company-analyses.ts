...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  issueNote: "The 10 August RHP and the official 11 August price-band advertisement confirm 3,94,82,000 shares: 2,94,82,000 fresh shares and 1,00,00,000 OFS shares sold by promoters Kantilal Kheemraj Jain and Manoj Kantilal Jain. The ₹88–₹93 band, 160-share lot and 18–20 August bidding are primary-source verified; the minimum application at the cap is ₹14,880. BSE issue record 7889 still showed a one-share market lot and minimum bid at 16:57 IST on 17 August, which conflicts with the official price advertisement and appears to be a pre-open placeholder; this analysis therefore uses the 160-share marketed lot while flagging the exchange display for recheck. At ₹93, the offer is approximately ₹367.18 crore, split into ₹274.18 crore fresh and ₹93 crore OFS. BSE classified the issue as forthcoming, and its issue record contained no anchor-allocation file, addendum or corrigendum at the 16:57 IST cut-off. Anchor bidding was scheduled for 17 August, one working day before the public offer; the final allocation remains unavailable and is not estimated here.",
