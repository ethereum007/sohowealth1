...
export const companyIpoAnalyses: CompanyIpoAnalysis[] = [{
  ...
  metrics: [
    ...
    { label: "NSE final-day close-window demand", value: "58,57,600 bids / 1.99×", context: "Official feed rechecked at approximately 6:34 p.m. IST on 18 August against the 29,45,600-share displayed gross offer. Because that denominator includes 1,48,800 market-maker shares, demand is approximately 2.09× the residual 27,96,800-share public pool by calculation. The feed still marked the issue Active after the scheduled bidding period; the reading is not a final reconciled or category-wise book." },
