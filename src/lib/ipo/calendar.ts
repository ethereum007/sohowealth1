...
export const august2026Snapshot = {
  ...
  verificationNotes: [
    ...
    "Gaja Alternative Asset Management's 12 August RHP, price advertisement and BSE issue record 7895 confirm a ₹550 crore offer: ₹450 crore fresh issue, ₹100 crore OFS, ₹152–₹160 band, 93-share lot and 19–21 August bidding. BSE had not published an anchor-allocation notice, addendum or corrigendum early on 17 August; the scheduled anchor date is 18 August. ₹372 crore, or 82.7% of fresh proceeds, is allocated to sponsor commitments and the related bridge repayment across FY27–FY29. The deeper balance-sheet review now separates ₹131.47 crore of trade receivables with no impairment allowance, ₹271.93 crore of alternative-fund investments, ₹58.58 crore of uncalled commitments, ₹26.69 crore of advances recoverable in cash and ₹2.64 crore explicitly tagged as carried-interest receivable.",
    ...
    "Credent Connect N Care's 8 August RHP confirms 49,68,000 fresh shares, including a 2,52,000-share market-maker reservation. The full offer at the cap is approximately ₹93.90 crore; the RHP directs ₹63.80 crore to parent and subsidiary working capital, while their combined gap is projected to rise from ₹51.89 crore at FY26 to ₹124.65 crore by FY28. NSE's feed retrieved early on 17 August remained at 11.23× and the two-lot minimum requires ₹2,26,800 at the cap. The page now adds nil bad-debt provision across ₹58.83 crore of receivables, the FY25 adoption and historical restatement of unbilled-revenue accounting, ₹10.91 crore of recallable unsecured loans equal to 47.42% of 30 June indebtedness, and lender security extending to receivables, promoter guarantees and residential collateral.",
    "Lalithaa Jewellery Mart's final RHP and price advertisement confirm a ₹1,200 crore fresh issue, ₹500 crore OFS, ₹190–₹201 band and 74-share lot. BSE's 14 August notice confirms a ₹508.20 crore anchor allocation at ₹201; NSE and BSE show 6,27,61,403 shares in the post-anchor public bid pool. FY26 inventory was 89.7% of assets, while the JILABA sales-and-inventory audit trail did not operate throughout FY26. The page now also maps ₹8,683.03 crore of gold inventory carried at annual weighted-average cost subject to a net-realizable-value floor, shows customer-scheme advances rising 159.5% since FY24 to ₹5,042.75 crore and separates ₹441.26 crore of lease liabilities from the reported borrowing figure.",
    ...
    "Horizon Industrial Parks' final RHP and price advertisement confirm an all-fresh ₹2,600 crore issue, ₹57–₹60 band, 250-share lot and ₹2,250 crore debt-repayment object. BSE's 14 August notice confirms a ₹1,167.75 crore anchor allocation at ₹60; NSE and BSE show a 25,13,56,273-share post-anchor public pool. Post-repayment net external debt remains about 3.28× FY26 EBITDA. The page now also separates five- to 10-year lease terms from one- to five-year lock-ins, maps the ₹0.90 crore lifetime loss allowance against ₹35.79 crore of gross receivables and records 1.16× pre-issue DSCR, 1.36× interest-service cover and ₹77.94 crore of recallable subsidiary debt.",
    ...
    "Sunshine Pictures' final RHP, official price advertisement and BSE issue record 7892 confirm 48,00,034 fresh shares, 30,37,157 OFS shares, a ₹342–₹360 band and 41-share lot. The page now shows trade receivables increasing 8.35× since FY24 to ₹66.51 crore with no loss allowance, and explains that content-cost amortisation depends on expected unrealised revenue as a share of total expected revenue. An immediate write-down occurs only when net expected unrealised revenue falls below unamortised cost. The issuer also states a 30% annual-budget limit per project, but own productions bear all overruns and title-level compliance is not disclosed.",
    "Q&T Foods' final prospectus corrects the issue size to ₹26.2476 crore, confirms ₹22.59 crore estimated net proceeds and a 2,400-share minimum application. BSE had not published final allotment or listing approval early on 17 August. Receivables and inventory represented 87.64% of FY26 current assets, inventory had risen 114.7% since FY24 and the prospectus attributes the build to raw material not fully consumed in production. The analysis also retains 91.33% FY26 utilisation, the roughly 101-day cash cycle, dealer-credit, FEFO, promoter-guarantee, statutory-payment, litigation and FSSAI controls.",
    ...
    "Sham Foam's 10 August final prospectus and BSE issue record 7881 confirm a 31,14,000-share fresh issue at ₹130, including a 1,56,000-share market-maker reservation, a 2,000-share minimum application and a proposed 18 August listing. BSE had not published final allotment or listing approval early on 17 August. The page now shows ₹25.40 crore of receivables, a 93-day collection cycle, ₹9.50 crore of inventory and ₹3.52 crore of unsecured demand loans; receivables and inventory together represented 80.7% of current assets. It also flags five cheque-dishonour cases against one customer and continuing promoter mortgages and guarantees alongside the unordered ₹14.72 crore capex programme.",
