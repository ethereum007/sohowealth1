...
export const august2026Snapshot = {
  ...
  verificationNotes: [
    ...
    "Technocrats Plasma's issuer-hosted RHP confirms 46,20,000 fresh shares and 14–18 August bidding. BSE notice 20260813-18 confirms 13,14,000 anchor shares at ₹132. The 33,06,000-share live display is post-anchor but still includes 2,31,000 market-maker shares; the residual public-investor pool is 30,75,000 shares.",
    "Shankesh Jewellers' official 11 August price-band advertisement now verifies the ₹88–₹93 band, 160-share lot, 3,94,82,000-share offer and 18–20 August bidding; the prior merchant-banker source gap is resolved.",
    "Skytech Infinite Platform's official price advertisement confirms a ₹73–₹77 band and a 3,200-share minimum bid, equal to ₹2,33,600–₹2,46,400. NSE's 16 August feed shows the issue active; its final RHP allocates up to ₹16.81 crore to working capital and assumes debtor days improve from 196 to 110.",
    "ENS Enterprises remains live in BSE's 16 August feed at ₹87–₹92. BSE notice 20260813-19 confirms 10,26,000 anchor shares at ₹92, worth ₹9.44 crore. The 25,76,400-share live display is post-anchor but still includes 1,81,200 market-maker shares; the residual public-investor pool is 23,95,200 shares. The RHP records nil subscription revenue in FY24–FY26 despite the SaaS product narrative.",
    "Fascinate Textiles remained active through 19 August in NSE's 16 August current-issue feed, superseding the RHP's original 13 August close. The feed showed 23,04,800 bids against 42,93,600 displayed gross-offer shares, or 0.54×; the final RHP also shows that IPO funding covers ₹25.15 crore of a projected ₹68.95 crore FY27 working-capital gap.",
    "Pramodini Medicare's final RHP confirms ₹110–₹118, a 1,200-share market lot, a two-lot or 2,400-share minimum application and a proposed 19 August listing. Its page now uses the audited FY24–FY26 statements and distinguishes pre-offer headline EPS from post-offer dilution.",
    ...
    "Sunshine Pictures' final RHP, official price advertisement and BSE issue record 7892 confirm 48,00,034 fresh shares, 30,37,157 OFS shares, a ₹342–₹360 band and 41-share lot. The RHP projects a ₹320.49 crore FY27 working-capital requirement funded by ₹112.50 crore of offer proceeds and ₹207.99 crore of equity/internal accruals; FY26 inventory and receivable days were 1,328 and 233, versus FY27 estimates of 314 and 117.",
    "Q&T Foods' final prospectus corrects the issue size to ₹26.2476 crore, confirms ₹22.59 crore estimated net proceeds and a 2,400-share minimum application, and supplies audited FY24–FY26 statements plus dilution-consistent valuation context.",
    ...
    "Sham Foam's 10 August final prospectus and BSE issue record 7881 confirm a 31,14,000-share fresh issue at ₹130, including a 1,56,000-share market-maker reservation, a 2,000-share minimum application and a proposed 18 August listing. Its page now uses audited FY24–FY26 statements, corrects net proceeds and capex, and distinguishes the prospectus's pre-issue P/E from post-issue dilution.",
