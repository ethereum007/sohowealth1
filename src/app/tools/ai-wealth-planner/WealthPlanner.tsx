        ...
        {step === 3 && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col justify-between gap-4 text-xs leading-relaxed text-slate-500 sm:flex-row">
              ...
              <div className="flex flex-wrap gap-4"><button type="button" onClick={savePlan} className="inline-flex shrink-0 items-center gap-2 font-semibold text-[#0B1F3A]"><Save className="h-4 w-4" /> Save on this device</button><button type="button" onClick={() => window.print()} className="inline-flex shrink-0 items-center gap-2 font-semibold text-[#0B1F3A]"><Download className="h-4 w-4" /> Save as PDF</button></div>
            </div>
