...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: Array<{
    ...
    { path: "/nri-telugu",       lastModified: "2026-08-23", changeFrequency: "weekly",  priority: 0.95 },
    { path: "/telugu-nri/usa",   lastModified: "2026-08-23", changeFrequency: "monthly", priority: 0.9 },
    { path: "/telugu-nri/uae",   lastModified: "2026-08-23", changeFrequency: "monthly", priority: 0.9 },
    { path: "/telugu-nri/returning-to-india", lastModified: "2026-08-23", changeFrequency: "monthly", priority: 0.9 },
