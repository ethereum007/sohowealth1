...
export const metadata: Metadata = {
  title: "Wealth Planning for HNIs, Founders & NRIs | SoHo Wealth",
  description:
    "Bring mutual funds, PMS, SIFs, employer stock, property and cross-border assets into one decision framework for HNIs, founders and NRIs across India.",
